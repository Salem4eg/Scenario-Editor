...
void ScenarioSetupWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->startProgram((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ScenarioSetupWidget::*)(QString )>(_a, &ScenarioSetupWidget::startProgram, 0))
            return;
    }
}
...
// SIGNAL 0
void ScenarioSetupWidget::startProgram(QString _t1)
{
